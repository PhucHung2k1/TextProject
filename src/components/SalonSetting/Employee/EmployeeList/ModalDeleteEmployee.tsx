...
export const ModalDeleteEmployee: React.FC<ModalDeleteRoleProps> = ({
  item,
  handleCloseModal,
}) => {
  ...
  return (
    <div className="flex h-auto w-[568px] flex-col items-center justify-center gap-5 rounded bg-white p-5 shadow-md ">
      <div className="text-xl font-bold text-text-title">Remove Employee?</div>
      <div className="text-base text-primary-dark">
        Would you like to remove "{item.LastName} {item.FirstName}"?
      </div>
